...
def create_fig():
    ...
    return fig, points, line, patch


def give_me_json():
    fig, points, line, patch = create_fig()
    plugins.connect(fig, LinkedDragPlugin(points[0], line[0], patch))

    # mpld3.save_html(fig, "mpld3_ex1.html")

    # mpld3.show()

    mpld3.save_html(fig, 'templates/hi.html')
    # return mpld3.save_html(fig, 'templates/hi.html')
